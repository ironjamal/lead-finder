    ...
    >
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          className="rounded-lg border border-fg/15 bg-bg px-3 py-2 text-fg placeholder:text-muted/70 outline-none focus:border-accent"
          required
        />
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <select
          ...
          className="rounded-lg border border-fg/15 bg-bg px-3 py-2 text-fg outline-none focus:border-accent"
        >
